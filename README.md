About jupyter-project-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-project-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/fcollonval/jupyter-project
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9843&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-project-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-project` can be installed with `conda`:
...
```
mamba install jupyter-project
```

It is possible to list all of the versions of `jupyter-project` available on your platform with `conda`:
...
```
mamba search jupyter-project --channel conda-forge
```
...
mamba repoquery search jupyter-project --channel conda-forge

# List packages depending on `jupyter-project`:
mamba repoquery whoneeds jupyter-project --channel conda-forge

# List dependencies of `jupyter-project`:
mamba repoquery depends jupyter-project --channel conda-forge
```
